...
var data = [],
    ...
    h,
    m,
    names = ['All Day Event', 'Long Event', 'Daily Hours 9-8', 'Repeating Event', 'Training', 'Meeting', 'Mr. Behnke', 'Date', 'Ms. Tubbs'],
